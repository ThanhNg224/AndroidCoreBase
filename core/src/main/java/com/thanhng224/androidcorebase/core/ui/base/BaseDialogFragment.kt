        ...
        dialog?.window?.let { window ->
            ...
            val animStyle =
                when (dialogAnimation) {
                    ...
                    DialogAnimation.FADE -> R.style.Animation_AndroidCoreBase_Dialog_Fade
                    DialogAnimation.SLIDE -> R.style.Animation_AndroidCoreBase_Dialog_Slide
                    DialogAnimation.SCALE -> R.style.Animation_AndroidCoreBase_Dialog_Scale
                }
            if (animStyle != 0) {
